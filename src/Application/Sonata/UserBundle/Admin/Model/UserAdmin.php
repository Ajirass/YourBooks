...
use Sonata\UserBundle\Admin\Model\UserAdmin as BaseForm;

class UserAdmin extends BaseForm
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        {
            $optionsLetter = array(
                'label' => 'Pas de lettre de motivation',
                'required' => false,
                'disabled' => true
            );
        }
        ...
        $formMapper
            ...
            ->with('Profile')
                ...
                ->add('company', null, array('required' => false, 'label'=>'Compagnie'))
                ->add('siret', null, array('required' => false, 'label'=>'N° de SIRET'))
                ->add('fileCv', 'file', $optionsCv)
                ->add('fileMotivationLetter', 'file', $optionsLetter)
            ->end()
            ->with('Social')
